...
namespace TempLat
{
  /** @brief Tracks which entries in the layout carry redundant information, and if so, what
   * information. This, again, assumes FFTW layout.
   * - none: the complex value at this wavenumber has no redundancy, and can take any value.
   * - negativePartner: the value at this wavenumber is the complex conjugate of another value in the  globalSpace, and
   * we chose that this partner is the negative one.
