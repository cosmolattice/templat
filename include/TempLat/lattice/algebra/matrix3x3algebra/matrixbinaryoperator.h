#ifndef TEMPLAT_LATTICE_ALGEBRA_MATRIX3x3ALGEBRA_MATRIXBINARYOPERATOR_H
#define TEMPLAT_LATTICE_ALGEBRA_MATRIX3x3ALGEBRA_MATRIXBINARYOPERATOR_H
...
namespace TempLat
{
   ...
   **/
  template <typename R, typename T> class MatrixBinaryOperator
  {
  public:
    // Put public methods here. These should change very little over time.
    DEVICE_FUNCTION
    MatrixBinaryOperator(const R &pR, const T &pT) : mR(pR), mT(pT) {}

    DEVICE_FUNCTION
    MatrixBinaryOperator(const MatrixBinaryOperator &) = default;
