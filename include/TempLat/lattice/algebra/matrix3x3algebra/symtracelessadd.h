#ifndef COSMOINTERFACE_MATRIX3X3ALGEBRA_SYMTRACELESSADD_H
#define COSMOINTERFACE_MATRIX3X3ALGEBRA_SYMTRACELESSADD_H
...
namespace TempLat
{
  ...
  /** @brief A class which implements symmetric-traceless field addition.
   *
   * Unit test: ctest -R test-complexfieldadd
   **/
  template <typename R, typename T> class SymTracelessAddition : public SymTracelessBinaryOperator<R, T>
  {
  public:
