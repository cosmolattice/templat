...
namespace TempLat
{
   ...
   **/
  template <class R, class T> class HermSymTracelessMultiplicationTrace : public TempLat::BinaryOperator<R, T>
  {
  public:
    ...
    DEVICE_FUNCTION
    HermSymTracelessMultiplicationTrace(const R &pR, const T &pT) : TempLat::BinaryOperator<R, T>(pR, pT) {}
    ...
    DEVICE_FORCEINLINE_FUNCTION auto eval(const IDX &...idx) const
    {
        ...
        return cL[0] * cR[0] + cL[1] * cR[1] + cL[2] * cR[2] + conj(cL[1]) * cR[1] + cL[3] * cR[3] + cL[4] * cR[4] + conj(cL[2]) * cR[2] + conj(cL[4]) * cR[4] - cL[5] * (cR[0] + cR[3]);
    }
  ...
  {
    return HermSymTracelessMultiplicationTrace<R, T>(r, t);
  }
