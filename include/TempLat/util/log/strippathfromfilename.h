...
namespace TempLat
{
  ...
  {
    /* a hack https://www.youtube.com/watch?v=fZjYCQ8dzTc&feature=youtu.be&t=3679 putting an unresolved symbol in an
     * exception that is never thrown: this guarantees that this function is truly only evaluated at compiler time, or
     * else an error is raise. */
