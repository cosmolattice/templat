...
namespace TempLat
{
  ...
  void AllMatrixMultiplyTester::Test(TDDAssertion &tdd)
  {
...

    {
      ...
      // Test multiplication between a symmetric matrix (equivalent to the real projector) and a symTraceless field in
      // Fourier space
      ...
      fs.inFourierSpace()(1_c, 1_c) =
          2. / 3. * k1.inFourierSpace() - 1. / 3. * k2.inFourierSpace() - 1. / 3. * k3.inFourierSpace();
      fs.inFourierSpace()(1_c, 2_c) = k2.inFourierSpace();
      fs.inFourierSpace()(1_c, 3_c) = k3.inFourierSpace();
      fs.inFourierSpace()(2_c, 2_c) =
          -1. / 3. * k1.inFourierSpace() + 2. / 3. * k2.inFourierSpace() - 1. / 3. * k3.inFourierSpace();
      fs.inFourierSpace()(2_c, 3_c) = k3.inFourierSpace();

      auto symmat = ConstructSym(k1.inFourierSpace(), k1.inFourierSpace(), k1.inFourierSpace(), k2.inFourierSpace(),
                                 k2.inFourierSpace(), k3.inFourierSpace());
...

      {
        ...
        NDLoop<NDim>(view11, [&](const auto... idx) {
          ...
          this_correct &=
              AlmostEqual(view11(idx...), 2. / 3. * view1(idx...) * (view1(idx...) + view2(idx...) + view3(idx...)));
          this_correct &=
              AlmostEqual(view12(idx...), view1(idx...) * (-1. / 3. * view1(idx...) + 5. / 3. * view2(idx...) +
                                                           2. / 3. * view3(idx...)));
          if (!this_correct) {
            std::cout << "Matrix operation test failed at index (";
            ((std::cout << idx << ", "), ...);
            std::cout << ") got (" << view11(idx...) << ", " << view12(idx...) << ", "
      ...
      // Test multiplication between an hermitian matrix (equivalent to the complex projector) and a symTraceless field
      // in Fourier space
      ...
      auto hermmat = ConstructHerm(1. * k(1_c), Complexify(0., 1. * k(1_c)), Complexify(0., 1. * k(1_c)), 1. * k(2_c),
                                   Complexify(0., 1. * k(2_c)), 1. * k(3_c));
...

      {
        ...
        NDLoop<NDim>(view11r, [&](const auto... idx) {
          bool this_correct = true;
          this_correct &=
              AlmostEqual(view11r(idx...), view1(idx...) * (2. / 3. * view1(idx...) - 1. / 3. * view2(idx...) -
                                                            1. / 3. * view3(idx...)));
          ...
          this_correct &=
              AlmostEqual(view21i(idx...), -view1(idx...) * (2. / 3. * view1(idx...) - 1. / 3. * view2(idx...) -
                                                             1. / 3. * view3(idx...)) +
                                               view2(idx...) * view3(idx...));
          this_correct &= AlmostEqual(view31r(idx...), view3(idx...) * view3(idx...));
          this_correct &=
              AlmostEqual(view31i(idx...), -view1(idx...) * (2. / 3. * view1(idx...) - 1. / 3. * view2(idx...) -
                                                             1. / 3. * view3(idx...)) -
                                               view2(idx...) * view2(idx...));
          if (!this_correct) {
            std::cout << "Matrix operation test failed at index (";
            ((std::cout << idx << ", "), ...);
            std::cout << ") got (" << view11r(idx...) << "+ i * " << view11i(idx...) << ", " << view21r(idx...)
                      << "+ i * " << view21i(idx...) << ", " << view31r(idx...) << "+ i * " << view31i(idx...) << ", "
                      << view1(idx...) * (2. / 3. * view1(idx...) - 1. / 3. * view2(idx...) - 1. / 3. * view3(idx...))
                      << "+ i * " << view1(idx...) * (view2(idx...) + view3(idx...)) << ", "
                      << view2(idx...) * view2(idx...) << "+ i * "
                      << -view1(idx...) *
                                 (2. / 3. * view1(idx...) - 1. / 3. * view2(idx...) - 1. / 3. * view3(idx...)) +
                             view2(idx...) * view3(idx...)
                      << ", " << view3(idx...) * view3(idx...) << "+ i * "
                      << -view1(idx...) *
                                 (2. / 3. * view1(idx...) - 1. / 3. * view2(idx...) - 1. / 3. * view3(idx...)) -
                             view2(idx...) * view2(idx...)
                      << ")\n";
