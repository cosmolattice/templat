  ...
  void AllMatrixComponentsTester::Test(TDDAssertion &tdd)
  {
...

    {
      ...
      NDLoop<NDim>(view11, [&](const auto... idx) {
        ...
        this_correct &= AlmostEqual(view11(idx...), 2. / 3. * view1(idx...) * view1(idx...) -
                                                        1. / 3. * view2(idx...) * view2(idx...) -
                                                        1. / 3. * view3(idx...) * view3(idx...));
        this_correct &= AlmostEqual(view12(idx...), view1(idx...) * view2(idx...));
        this_correct &= AlmostEqual(view13(idx...), view1(idx...) * view3(idx...));
        this_correct &= AlmostEqual(view22(idx...), -1. / 3. * view1(idx...) * view1(idx...) +
                                                        2. / 3. * view2(idx...) * view2(idx...) -
                                                        1. / 3. * view3(idx...) * view3(idx...));
        this_correct &= AlmostEqual(view23(idx...), view2(idx...) * view3(idx...));
        // this_correct &= AlmostEqual(view33(idx...), - 1. / 3. * view1(idx...)*view1(idx...) - 1. / 3. *
        // view2(idx...)*view2(idx...) + 2. / 3. * view3(idx...)*view3(idx...));
        if (!this_correct) {
          std::cout << "Matrix operation test failed at index (";
          ((std::cout << idx << ", "), ...);
          std::cout << ") got (" << view11(idx...) << ", " << view12(idx...) << ", " << view13(idx...) << ", "
                    << view22(idx...) << ", " << view23(idx...) << "), expected ("
                    << 2. / 3. * view1(idx...) * view1(idx...) - 1. / 3. * view2(idx...) * view2(idx...) -
                           1. / 3. * view3(idx...) * view3(idx...)
                    << ", " << view1(idx...) * view2(idx...) << ", " << view1(idx...) * view3(idx...) << ", "
                    << -1. / 3. * view1(idx...) * view1(idx...) + 2. / 3. * view2(idx...) * view2(idx...) -
                           1. / 3. * view3(idx...) * view3(idx...)
                    << ", " << view2(idx...) * view3(idx...) << ")\n";
        }
