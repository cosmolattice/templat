...
find_library(FFTW_LIB fftw3 HINTS ${FFTW_DIR}/lib)
find_library(FFTW_THREADS_LIB fftw3_threads HINTS ${FFTW_DIR}/lib)
mark_as_advanced(FFTW_LIB FFTW_THREADS_LIB)

# If float support is enabled, find the single-precision FFTW libraries.
if(FLOAT)
  find_library(FFTWF_LIB fftw3f HINTS ${FFTW_DIR}/lib)
  find_library(FFTWF_THREADS_LIB fftw3f_threads HINTS ${FFTW_DIR}/lib)
  mark_as_advanced(FFTWF_LIB FFTWF_THREADS_LIB)
endif()

# If MPI support is enabled, we need to find the MPI-enabled FFTW libraries.
if(MPI)
  find_library(FFTW_MPI_LIB fftw3_mpi HINTS ${FFTW_DIR}/lib)
  mark_as_advanced(FFTW_MPI_LIB)

  if(FLOAT)
    find_library(FFTWF_MPI_LIB fftw3f_mpi HINTS ${FFTW_DIR}/lib)
...
if(OPENMP)
  find_library(FFTW_OPENMP_LIB fftw3_omp HINTS ${FFTW_DIR}/lib)
  mark_as_advanced(FFTW_OPENMP_LIB)

  if(FLOAT)
    find_library(FFTWF_OPENMP_LIB fftw3f_omp HINTS ${FFTW_DIR}/lib)
